...
(1, '旅行达人小明', '/img/头像1.jpg', '热爱探索世界各地的文化与美食，已完成30+国家旅行', 1, 5, 1250, 3420),
(2, '背包客小红', '/img/头像2.png', '穷游爱好者，用最少的钱走最多的路', 0, 3, 890, 2150),
(3, '探险家阿强', '/img/头像3.png', '极限运动爱好者，挑战世界各地的险峻山峰', 1, 4, 2100, 5680),
(4, '摄影师小陈', '/img/头像1.jpg', '用镜头记录旅途中的美好瞬间', 0, 6, 1560, 4320),
(5, '美食家小刘', '/img/头像2.png', '走遍世界只为寻找最地道的美食', 1, 2, 780, 1890),
(6, '穷游背包客', '/img/头像3.png', '学生党穷游攻略分享，月均旅行预算2000', 0, 4, 2340, 6780),
(7, '奢华旅行者', '/img/头像1.jpg', '分享高端酒店和私人定制旅行体验', 1, 3, 1890, 4560),
(8, '独自旅行者', '/img/头像2.png', '一个人的旅行，一个人的精彩', 0, 5, 1230, 3210),
(9, '吃货旅行家', '/img/头像3.png', '为了美食可以飞越半个地球', 1, 2, 670, 1540),
(10, '旅行摄影师', '/img/头像1.jpg', '专业旅行摄影，记录世界的美', 0, 7, 3450, 8920),
(11, '历史文化迷', '/img/头像2.png', '喜欢探访历史古迹，了解各地文化', 0, 3, 980, 2670),
(12, '自然探索者', '/img/头像3.png', '热爱大自然，徒步登山是我的生活方式', 1, 4, 1560, 4230);
...
(1, '东京', '日本', '东京', '日本首都，融合传统与现代的国际大都市，拥有丰富的美食文化和购物体验', '/img/富士山.jpg', 4.85, 15, 2560, 95.50),
(2, '巴黎', '法国', '巴黎', '浪漫之都，艺术与时尚的中心，埃菲尔铁塔和卢浮宫的所在地', '/img/埃菲尔铁塔.jpg', 4.90, 12, 2340, 98.20),
(3, '曼谷', '泰国', '曼谷', '东南亚最受欢迎的旅游城市，以寺庙、美食和夜市闻名', '/img/长尾船.png', 4.75, 10, 1890, 88.70),
(4, '纽约', '美国', '纽约', '世界金融中心，拥有自由女神像、时代广场等标志性景点', '/img/纽约城市.jpg', 4.80, 8, 2100, 92.30),
(5, '巴厘岛', '印度尼西亚', '巴厘岛', '印度尼西亚著名度假胜地，以海滩、梯田和独特的宗教文化著称', '/img/back1.png', 4.70, 9, 1670, 85.60),
(6, '伦敦', '英国', '伦敦', '历史悠久的国际都市，大本钟、伦敦眼和白金汉宫必去', '/img/back2.png', 4.75, 7, 1890, 89.40),
(7, '北京', '中国', '北京', '中国首都，拥有故宫、长城等世界文化遗产', '/img/1.jpg', 4.85, 14, 3200, 96.80),
(8, '上海', '中国', '上海', '中国最大城市，现代与传统交融的国际金融中心', '/img/4.jpg', 4.80, 11, 2890, 93.50),
(9, '新加坡', '新加坡', '新加坡', '花园城市，以干净整洁和美食闻名，适合家庭旅游', '/img/新加坡.jpg', 4.75, 6, 1450, 82.30),
(10, '清迈', '泰国', '清迈', '泰北玫瑰，以古城寺庙、夜市和悠闲氛围著称', '/img/2.jpg', 4.65, 5, 1230, 78.90),
(11, '京都', '日本', '京都', '日本古都，保存完好的寺庙神社和传统日式庭院', '/img/3.jpg', 4.80, 8, 1670, 87.50),
(12, '马尔代夫', '马尔代夫', '马累', '印度洋上的珍珠，以水上别墅和清澈海水闻名', '/img/希腊圣托尼尼.png', 4.90, 4, 980, 91.20);
...
(1, 1, 1, '东京7日深度游：从浅草寺到涩谷的完美行程', '带你领略东京的传统与现代魅力，包含详细行程安排和美食推荐', '<h1>东京7日深度游</h1><p>东京是一个充满活力的城市...</p>', '/img/富士山.jpg', '东京', 'international', 'free', 'published', '2026-04-15 10:00:00', 7, 15000.00, 12500, 450, 89, 230),
(2, 2, 4, '巴黎5日浪漫之旅：艺术与美食的完美结合', '探索巴黎的艺术殿堂，品尝正宗法式美食', '<h1>巴黎浪漫之旅</h1><p>巴黎是艺术与时尚的中心...</p>', '/img/埃菲尔铁塔.jpg', '巴黎', 'international', 'honeymoon', 'published', '2026-04-10 14:30:00', 5, 18000.00, 9800, 380, 76, 195),
(3, 3, 2, '曼谷6日穷游攻略：人均3000玩转泰国首都', '低预算也能玩转曼谷，省钱又有趣的旅行指南', '<h1>曼谷穷游攻略</h1><p>曼谷是东南亚最受欢迎的旅游城市...</p>', '/img/长尾船.png', '曼谷', 'international', 'free', 'published', '2026-04-05 09:15:00', 6, 3000.00, 15600, 620, 134, 310),
(4, 7, 3, '北京5日文化之旅：探寻中华文明的瑰宝', '深度体验北京的历史文化，从故宫到长城的完整攻略', '<h1>北京文化之旅</h1><p>北京是中国的首都...</p>', '/img/1.jpg', '北京', 'domestic', 'family', 'published', '2026-03-28 11:45:00', 5, 8000.00, 18900, 720, 156, 420),
(5, 8, 10, '上海3日现代都市游：感受魔都的独特魅力', '体验上海的现代与传统，从外滩到田子坊', '<h1>上海现代都市游</h1><p>上海是中国最大的城市...</p>', '/img/4.jpg', '上海', 'domestic', 'free', 'published', '2026-03-20 16:20:00', 3, 5000.00, 11200, 430, 98, 265),
(6, 5, 5, '巴厘岛7日蜜月之旅：浪漫与自然的完美融合', '适合新婚夫妇的巴厘岛浪漫行程', '<h1>巴厘岛蜜月之旅</h1><p>巴厘岛是印度尼西亚著名的度假胜地...</p>', '/img/back1.png', '巴厘岛', 'international', 'honeymoon', 'published', '2026-03-15 13:30:00', 7, 25000.00, 8900, 340, 72, 180),
(7, 1, 8, '东京3日快速游：首次访问东京的必看指南', '适合时间有限的东京精华游', '<h1>东京快速游</h1><p>只有3天时间也能玩转东京...</p>', '/img/2.jpg', '东京', 'international', 'free', 'published', '2026-03-10 10:00:00', 3, 6000.00, 7800, 290, 54, 145),
(8, 4, 6, '纽约4日经济游：学生党的纽约梦', '低预算玩转纽约，省钱又有趣的攻略', '<h1>纽约经济游</h1><p>纽约是世界金融中心...</p>', '/img/纽约城市.jpg', '纽约', 'international', 'free', 'published', '2026-03-05 15:45:00', 4, 8000.00, 6500, 250, 48, 120),
(9, 11, 11, '京都4日文化游：穿越千年的时光之旅', '深度体验京都的传统文化和历史', '<h1>京都文化游</h1><p>京都是日本的古都...</p>', '/img/3.jpg', '京都', 'international', 'free', 'published', '2026-02-28 09:30:00', 4, 10000.00, 5600, 220, 42, 95),
(10, 12, 7, '马尔代夫5日奢华游：水上别墅的极致体验', '享受顶级度假体验，水上别墅和私人沙滩', '<h1>马尔代夫奢华游</h1><p>马尔代夫是印度洋上的珍珠...</p>', '/img/希腊圣托尼尼.png', '马累', 'international', 'honeymoon', 'published', '2026-02-20 14:00:00', 5, 50000.00, 12000, 480, 92, 280);
...
(1, 2, NULL, '背包客小红', '/img/头像2.png', '太详细了！正计划去东京，收藏了', 25),
(1, 3, 1, '探险家阿强', '/img/头像3.png', '同求东京攻略，请问迪士尼值得去吗？', 8),
(1, 5, NULL, '美食家小刘', '/img/头像2.png', '筑地市场的海鲜真的太新鲜了，推荐寿司大和大和寿司', 18),
(1, 4, NULL, '摄影师小陈', '/img/头像1.jpg', '浅草寺的夜景拍照很出片，建议傍晚去', 12),
(2, 5, NULL, '美食家小刘', '/img/头像2.png', '巴黎的餐厅推荐太棒了，下次去一定要试试', 18),
(2, 7, NULL, '奢华旅行者', '/img/头像1.jpg', '这个预算对于蜜月游来说很合理，已经加入行程单', 12),
(3, 6, NULL, '穷游背包客', '/img/头像3.png', '穷游攻略太实用了，感谢分享！', 32),
(3, 9, NULL, '吃货旅行家', '/img/头像3.png', '考山路的夜市真的太棒了，芒果糯米饭绝了', 20),
(4, 11, NULL, '历史文化迷', '/img/头像2.png', '北京的文化之旅写得很详细，收藏了', 28),
(4, 12, NULL, '自然探索者', '/img/头像3.png', '长城的描述很真实，确实很壮观', 22),
(4, 5, NULL, '美食家小刘', '/img/头像2.png', '北京烤鸭推荐四季民福，比全聚德性价比高', 18),
(6, 7, NULL, '奢华旅行者', '/img/头像1.jpg', '巴厘岛蜜月太浪漫了，悬岸酒店一定要住', 20),
(10, 1, NULL, '旅行达人小明', '/img/头像1.jpg', '水上别墅太梦幻了，蜜月首选！', 25),
(10, 7, NULL, '奢华旅行者', '/img/头像1.jpg', '大部分酒店包含早餐和晚餐，午餐另付，也可以升级全包', 8);
...
(1, '旅行达人小明', '/img/头像1.jpg', 1, '刚从东京回来，太美了！浅草寺的樱花季真的不容错过。这次尝试了当地的小巷美食，发现了很多隐藏的宝藏餐厅', '2026-04-28 18:30:00', 156, 23, 12),
(3, '探险家阿强', '/img/头像3.png', 1, '今天挑战了北京慕田峪长城，虽然很累但成就感满满！站在长城上俯瞰群山，感觉一切都值得了', '2026-04-27 20:15:00', 234, 45, 28),
(5, '美食家小刘', '/img/头像2.png', 1, '曼谷的街头美食真的太棒了！从芒果糯米饭到泰式奶茶，每一口都是惊喜。强烈推荐大家去考山路逛逛', '2026-04-26 16:45:00', 189, 34, 15),
(10, '旅行摄影师', '/img/头像1.jpg', 0, '在巴黎埃菲尔铁塔下拍到了最美的日落，这次的摄影作品太满意了。分享几张精选照片给大家', '2026-04-25 21:00:00', 312, 56, 42),
(8, '独自旅行者', '/img/头像2.png', 0, '一个人的旅行也能很精彩！在清迈古城骑行，感受当地人的慢生活，这种自由的感觉太棒了', '2026-04-24 19:30:00', 145, 28, 18),
(6, '穷游背包客', '/img/头像3.png', 0, '学生党也能玩转纽约！分享我的穷游攻略，5天只花了5000元，包含机票住宿和所有开销', '2026-04-23 17:20:00', 278, 67, 35),
(7, '奢华旅行者', '/img/头像1.jpg', 1, '马尔代夫的水上别墅真的太梦幻了！从阳台直接跳进清澈的海里，这种体验无与伦比', '2026-04-22 15:10:00', 423, 78, 56),
(12, '自然探索者', '/img/头像3.png', 1, '在巴厘岛徒步了阿贡火山，虽然很艰辛，但山顶的日出美到窒息。大自然的力量真的很震撼', '2026-04-21 13:45:00', 198, 32, 22);
...
(1, 2, NULL, '背包客小红', '/img/头像2.png', '樱花季真的太美了！请问是几月份去的？', 8),
(1, 1, 1, '旅行达人小明', '/img/头像1.jpg', '我是3月底4月初去的，正好赶上樱花盛开', 5),
(2, 12, NULL, '自然探索者', '/img/头像3.png', '长城真的很壮观，下次一定要去！', 12),
(3, 9, NULL, '吃货旅行家', '/img/头像3.png', '曼谷的美食真的太诱人了，已经加入旅行清单', 15),
(4, 3, NULL, '探险家阿强', '/img/头像3.png', '这些照片拍得太美了，摄影技术真棒！', 20),
(4, 10, 5, '旅行摄影师', '/img/头像1.jpg', '谢谢夸奖！那天的光线特别美', 8),
(5, 6, NULL, '穷游背包客', '/img/头像3.png', '一个人的旅行也很精彩，学到了很多', 10),
(6, 3, NULL, '探险家阿强', '/img/头像3.png', '5000元玩纽约太厉害了，请问是怎么做到的？', 18),
(6, 6, 8, '穷游背包客', '/img/头像3.png', '主要是住青旅和吃街头美食，交通用地铁通票', 12),
(7, 1, NULL, '旅行达人小明', '/img/头像1.jpg', '水上别墅太梦幻了，蜜月首选！', 25),
(8, 3, NULL, '探险家阿强', '/img/头像3.png', '阿贡火山徒步确实很挑战，但值得！', 15);
