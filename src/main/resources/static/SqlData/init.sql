...
CREATE TABLE IF NOT EXISTS guides (
  ...
  status INT DEFAULT 0 COMMENT '0=待审�? 1=已通过, 2=已拒�? 3=已下�?,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
-- 默认管理�?admin/admin123 由应用启动时自动创建（BCrypt加密�?
-- ============================================================
-- 14) 管理员操作日�?-- ============================================================
...
(2, '背包客小�?, '/avatars/user2.jpg', '穷游爱好者，用最少的钱走最多的�?, 0, 3, 890, 2150),
(3, '探险家阿�?, '/avatars/user3.jpg', '极限运动爱好者，挑战世界各地的险峻山�?, 1, 4, 2100, 5680),
(4, '摄影师小�?, '/avatars/user4.jpg', '用镜头记录旅途中的美好瞬�?, 0, 6, 1560, 4320),
(5, '美食家小�?, '/avatars/user5.jpg', '走遍世界只为寻找最地道的美�?, 1, 2, 780, 1890),
(6, '穷游背包�?, '/avatars/user6.jpg', '学生党穷游攻略分享，月均旅行预算2000�?, 0, 4, 2340, 6780),
(7, '奢华旅行�?, '/avatars/user7.jpg', '分享高端酒店和私人定制旅行体�?, 1, 3, 1890, 4560),
(8, '独自旅行�?, '/avatars/user8.jpg', '一个人的旅行，一个人的精�?, 0, 5, 1230, 3210),
(9, '吃货旅行�?, '/avatars/user9.jpg', '为了美食可以飞越半个地球', 1, 2, 670, 1540),
(10, '旅行摄影�?, '/avatars/user10.jpg', '专业旅行摄影，记录世界的�?, 0, 7, 3450, 8920),
(11, '历史文化�?, '/avatars/user11.jpg', '喜欢探访历史古迹，了解各地文�?, 0, 3, 980, 2670),
(12, '自然探索�?, '/avatars/user12.jpg', '热爱大自然，徒步登山是我的生活方�?, 1, 4, 1560, 4230);
...
(1, '东京', '日本', '东京', '日本首都，融合传统与现代的国际大都市，拥有丰富的美食文化和购物体�?, '/destinations/tokyo.jpg', 4.85, 15, 2560, 95.50),
...
(4, '纽约', '美国', '纽约', '世界金融中心，拥有自由女神像、时代广场等标志性景�?, '/destinations/newyork.jpg', 4.80, 8, 2100, 92.30),
(5, '巴厘�?, '印度尼西�?, '巴厘�?, '印尼著名度假胜地，以海滩、梯田和独特的宗教文化著�?, '/destinations/bali.jpg', 4.70, 9, 1670, 85.60),
(6, '伦敦', '英国', '伦敦', '历史悠久的国际都市，大本钟、伦敦眼和白金汉宫必�?, '/destinations/london.jpg', 4.75, 7, 1890, 89.40),
...
(9, '新加�?, '新加�?, '新加�?, '花园城市，以干净整洁和美食闻名，适合家庭旅游', '/destinations/singapore.jpg', 4.75, 6, 1450, 82.30),
(10, '清迈', '泰国', '清迈', '泰北玫瑰，以古城寺庙、夜市和悠闲氛围著称', '/destinations/chiangmai.jpg', 4.65, 5, 1230, 78.90),
(11, '京都', '日本', '京都', '日本古都，保存完好的寺庙神社和传统日式庭�?, '/destinations/kyoto.jpg', 4.80, 8, 1670, 87.50),
...
(1, 1, 1, '东京7日深度游：从浅草寺到涩谷的完美行�?, '带你领略东京的传统与现代魅力，包含详细行程安排和美食推荐', '<h1>东京7日深度游</h1><p>东京是一个充满活力的城市...</p>', '/guides/tokyo_guide1.jpg', '东京', 'international', 'free', 'published', '2026-04-15 10:00:00', 7, 15000.00, 12500, 450, 89, 230),
(2, 2, 4, '巴黎5日浪漫之旅：艺术与美食的完美结合', '探索巴黎的艺术殿堂，品味正宗法式美食', '<h1>巴黎浪漫之旅</h1><p>巴黎是艺术与时尚的中�?..</p>', '/guides/paris_guide1.jpg', '巴黎', 'international', 'honeymoon', 'published', '2026-04-10 14:30:00', 5, 18000.00, 9800, 380, 76, 195),
...
(4, 7, 3, '北京5日文化之旅：探寻中华文明的瑰�?, '深度体验北京的历史文化，从故宫到长城的完整攻�?, '<h1>北京文化之旅</h1><p>北京是中国的首都...</p>', '/guides/beijing_guide1.jpg', '北京', 'domestic', 'family', 'published', '2026-03-28 11:45:00', 5, 8000.00, 18900, 720, 156, 420),
(5, 8, 10, '上海3日现代都市游：感受魔都的独特魅力', '体验上海的现代与传统，从外滩到田子坊', '<h1>上海现代都市�?/h1><p>上海是中国最大的城市...</p>', '/guides/shanghai_guide1.jpg', '上海', 'domestic', 'free', 'published', '2026-03-20 16:20:00', 3, 5000.00, 11200, 430, 98, 265),
(6, 5, 5, '巴厘�?日蜜月之旅：浪漫与自然的完美融合', '适合新婚夫妇的巴厘岛浪漫行程', '<h1>巴厘岛蜜月之�?/h1><p>巴厘岛是印尼著名的度假胜�?..</p>', '/guides/bali_guide1.jpg', '巴厘�?, 'international', 'honeymoon', 'published', '2026-03-15 13:30:00', 7, 25000.00, 8900, 340, 72, 180),
(7, 1, 8, '东京3日快速游：首次访问东京的必看指南', '适合时间有限的东京精华游', '<h1>东京快速游</h1><p>只有3天时间也能玩转东�?..</p>', '/guides/tokyo_guide2.jpg', '东京', 'international', 'free', 'published', '2026-03-10 10:00:00', 3, 6000.00, 7800, 290, 54, 145),
(8, 4, 6, '纽约4日经济游：学生党的纽约梦', '低预算玩转纽约，省钱又有趣的攻略', '<h1>纽约经济�?/h1><p>纽约是世界金融中�?..</p>', '/guides/newyork_guide1.jpg', '纽约', 'international', 'free', 'published', '2026-03-05 15:45:00', 4, 8000.00, 6500, 250, 48, 120),
(9, 11, 11, '京都4日文化游：穿越千年的时光之旅', '深度体验京都的传统文化和历史', '<h1>京都文化�?/h1><p>京都是日本的古都...</p>', '/guides/kyoto_guide1.jpg', '京都', 'international', 'free', 'published', '2026-02-28 09:30:00', 4, 10000.00, 5600, 220, 42, 95),
(10, 12, 7, '马尔代夫5日奢华游：水上别墅的极致体验', '享受顶级度假体验，水上别墅和私人沙滩', '<h1>马尔代夫奢华�?/h1><p>马尔代夫是印度洋上的珍珠...</p>', '/guides/maldives_guide1.jpg', '马累', 'international', 'honeymoon', 'published', '2026-02-20 14:00:00', 5, 50000.00, 12000, 480, 92, 280);
...
(1, 1, '抵达东京 & 浅草�?, '抵达东京后前往浅草寺，感受传统日式文化', 1),
(1, 2, '涩谷 & 原宿潮流之旅', '探索东京最时尚的街�?, 2),
(1, 3, '东京迪士尼乐�?, '在迪士尼乐园度过欢乐的一�?, 3),
(1, 4, '秋叶�?& 上野', '动漫圣地秋叶原和文化气息浓厚的上�?, 4),
(1, 5, '新宿 & 歌舞伎町', '体验东京的夜生活', 5),
(1, 6, '箱根一日游', '前往箱根欣赏富士山美�?, 6),
(1, 7, '返回 & 购物', '最后一天购物和整理行李', 7),
(4, 1, '天安门广�?& 故宫', '游览世界最大的城市广场和明清皇�?, 1),
(4, 2, '长城一日游', '登上万里长城，感受古代工程奇�?, 2),
(4, 3, '颐和�?& 圆明�?, '欣赏皇家园林的精�?, 3),
(4, 4, '南锣鼓巷 & 什刹海', '体验老北京的胡同文化', 4),
(4, 5, '798艺术�?& 三里�?, '感受北京的现代艺术和时尚', 5),
(3, 1, '大皇�?& 卧佛�?, '参观泰国最著名的佛教建�?, 1),
(3, 2, '暹罗商圈购物', '在曼谷最大的购物中心购物', 2),
(3, 3, '水上市场 & 铁道市场', '体验泰国独特的水上市场文�?, 3),
(3, 4, '考山路夜生活', '在考山路感受曼谷的夜生�?, 4),
(3, 5, '美功铁道市场', '观看火车穿过市场的奇�?, 5),
(3, 6, '返回 & 最后购�?, '购买纪念品和特产', 6);
...
(1, 2, NULL, '背包客小�?, '/avatars/user2.jpg', '太详细了！正好计划去东京，收藏了�?, 25),
(1, 3, 1, '探险家阿�?, '/avatars/user3.jpg', '同求东京攻略，请问迪士尼值得去吗�?, 8),
(1, 1, 2, '旅行达人小明', '/avatars/user1.jpg', '迪士尼非常值得去，建议安排一整天，早起入园排队能玩更多项�?, 15),
(1, 5, NULL, '美食家小�?, '/avatars/user5.jpg', '筑地市场的海鲜真的太新鲜了，推荐寿司大和大和寿司', 18),
(1, 9, 4, '吃货旅行�?, '/avatars/user9.jpg', '同意！还有丰洲市场也不错，人比筑地少一�?, 6),
(1, 4, NULL, '摄影师小�?, '/avatars/user4.jpg', '浅草寺的夜景拍照很出片，建议傍晚�?, 12),
(1, 8, 6, '独自旅行�?, '/avatars/user8.jpg', '一个人去东京安全吗？语言不通怎么办？', 4),
(1, 1, 7, '旅行达人小明', '/avatars/user1.jpg', '东京治安很好，地铁有英文标识，Google Maps完全够用', 9),
(2, 5, NULL, '美食家小�?, '/avatars/user5.jpg', '巴黎的餐厅推荐太棒了，下次去一定要试试', 18),
(2, 7, NULL, '奢华旅行�?, '/avatars/user7.jpg', '这个预算对于蜜月游来说很合理，已经加入行程单', 12),
(2, 10, 10, '旅行摄影�?, '/avatars/user10.jpg', '卢浮宫建议预留至少半天，蒙娜丽莎那边人超�?, 14),
(2, 6, 11, '穷游背包�?, '/avatars/user6.jpg', '请问巴黎地铁方便吗？有没有推荐的交通卡�?, 5),
(2, 4, 13, '摄影师小�?, '/avatars/user4.jpg', '推荐买Paris Pass，地铁公交博物馆都能�?, 8),
(3, 6, NULL, '穷游背包�?, '/avatars/user6.jpg', '穷游攻略太实用了，感谢分享！', 32),
(3, 8, 15, '独自旅行�?, '/avatars/user8.jpg', '请问曼谷安全吗？一个人去需要注意什么？', 5),
(3, 2, 16, '背包客小�?, '/avatars/user2.jpg', '曼谷整体很安全，就是注意小偷和突突车砍价', 7),
(3, 9, NULL, '吃货旅行�?, '/avatars/user9.jpg', '考山路的夜市真的太棒了，芒果糯米饭绝�?, 20),
(3, 12, 18, '自然探索�?, '/avatars/user12.jpg', '水上市场推荐丹嫩沙多，早上去人少', 10),
(3, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '大皇宫值得去吗？感觉门票有点贵', 3),
(4, 11, NULL, '历史文化�?, '/avatars/user11.jpg', '北京的文化之旅写得很详细，收藏了', 28),
(4, 12, NULL, '自然探索�?, '/avatars/user12.jpg', '长城的描述很真实，确实很壮观', 22),
(4, 1, 21, '旅行达人小明', '/avatars/user1.jpg', '故宫建议租个电子讲解器，不然很多故事都不知道', 15),
(4, 5, NULL, '美食家小�?, '/avatars/user5.jpg', '北京烤鸭推荐四季便宜坊，比全聚德性价比高', 18),
(4, 8, 24, '独自旅行�?, '/avatars/user8.jpg', '便宜坊在哪？需要提前预约吗�?, 3),
(4, 3, 25, '探险家阿�?, '/avatars/user3.jpg', '在崇文门附近，建议下�?点去排队', 5),
(5, 1, NULL, '旅行达人小明', '/avatars/user1.jpg', '上海的现代都市感确实很强', 15),
(5, 6, NULL, '穷游背包�?, '/avatars/user6.jpg', '田子坊和外滩都很出片，推荐晚上去', 10),
(5, 4, 28, '摄影师小�?, '/avatars/user4.jpg', '外滩夜景最佳拍摄时间是晚上7-8点，灯光最�?, 12),
(5, 9, NULL, '吃货旅行�?, '/avatars/user9.jpg', '上海的小笼包推荐南翔馒头店，城隍庙那�?, 8),
(6, 7, NULL, '奢华旅行�?, '/avatars/user7.jpg', '巴厘岛蜜月太浪漫了，悬崖酒店一定要�?, 20),
(6, 1, 32, '旅行达人小明', '/avatars/user1.jpg', '请问悬崖酒店大概什么价位？需要提前多久预订？', 6),
(6, 5, 33, '美食家小�?, '/avatars/user5.jpg', '推荐乌兰巴图的悬崖酒店，提前1-2个月预订，价�?000-5000/�?, 9),
(6, 11, NULL, '历史文化�?, '/avatars/user11.jpg', '海神庙日落真的很美，建议下午4点前�?, 14),
(6, 8, 35, '独自旅行�?, '/avatars/user8.jpg', '一个人去巴厘岛合适吗？还是更适合情侣�?, 4),
(7, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '3天也能玩东京？行程安排得很紧�?, 10),
(7, 6, 37, '穷游背包�?, '/avatars/user6.jpg', '时间紧的话推荐买地铁一日券，能省不少钱', 8),
(7, 9, NULL, '吃货旅行�?, '/avatars/user9.jpg', '3天的话建议把浅草和涩谷放同一天，节省时间', 6),
(8, 1, NULL, '旅行达人小明', '/avatars/user1.jpg', '学生党也能玩纽约，太励志�?, 12),
(8, 8, 40, '独自旅行�?, '/avatars/user8.jpg', '青旅推荐哪家？安全吗�?, 5),
(8, 6, 41, '穷游背包�?, '/avatars/user6.jpg', '推荐Hostelling International的纽约分店，位置好价格便�?, 7),
(8, 12, NULL, '自然探索�?, '/avatars/user12.jpg', '中央公园免费又好玩，值得花半天时�?, 9),
(9, 1, NULL, '旅行达人小明', '/avatars/user1.jpg', '京都的寺庙真的很有韵味，清水寺必�?, 15),
(9, 4, 44, '摄影师小�?, '/avatars/user4.jpg', '清水寺建议早上去，人少光线好', 8),
(9, 12, NULL, '自然探索�?, '/avatars/user12.jpg', '岚山竹林太美了，推荐租自行车游览', 12),
(9, 9, 46, '吃货旅行�?, '/avatars/user9.jpg', '京都抹茶甜点推荐中村藤吉，宇治本店最正宗', 10),
(10, 1, NULL, '旅行达人小明', '/avatars/user1.jpg', '水上别墅太梦幻了，蜜月首选！', 25),
(10, 5, 48, '美食家小�?, '/avatars/user5.jpg', '请问酒店包餐吗？还是需要另外付费？', 6),
(10, 7, 49, '奢华旅行�?, '/avatars/user7.jpg', '大部分套餐包含早餐和晚餐，午餐另付，也可以升级全�?, 8),
(10, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '马尔代夫浮潜真的能看到很多鱼吗？', 10),
(10, 12, 51, '自然探索�?, '/avatars/user12.jpg', '水下生态很丰富，推荐带防水相机拍照', 7),
(10, 8, NULL, '独自旅行�?, '/avatars/user8.jpg', '一个人去马尔代夫会不会太贵了？', 4);
...
(3, '探险家阿�?, '/avatars/user3.jpg', 1, '今天挑战了北京慕田峪长城，虽然很累但成就感满满！站在长城上俯瞰群山，感觉一切都值得了�?, '2026-04-27 20:15:00', 234, 45, 28),
(5, '美食家小�?, '/avatars/user5.jpg', 1, '曼谷的街头美食真的太棒了！从芒果糯米饭到泰式奶茶，每一口都是惊喜。强烈推荐大家去考山路逛逛�?, '2026-04-26 16:45:00', 189, 34, 15),
(10, '旅行摄影�?, '/avatars/user10.jpg', 0, '在巴黎埃菲尔铁塔下拍到了最美的日落，这次的摄影作品太满意了。分享几张精选照片给大家�?, '2026-04-25 21:00:00', 312, 56, 42),
(8, '独自旅行�?, '/avatars/user8.jpg', 0, '一个人的旅行也能很精彩！在清迈古城骑行，感受当地人的慢生活，这种自由的感觉太棒了�?, '2026-04-24 19:30:00', 145, 28, 18),
(6, '穷游背包�?, '/avatars/user6.jpg', 0, '学生党也能玩转纽约！分享我的穷游攻略�?天只花了5000元，包含机票住宿和所有开销�?, '2026-04-23 17:20:00', 278, 67, 35),
(7, '奢华旅行�?, '/avatars/user7.jpg', 1, '马尔代夫的水上别墅真的太梦幻了！从阳台直接跳进清澈的海里，这种体验无与伦比�?, '2026-04-22 15:10:00', 423, 78, 56),
(12, '自然探索�?, '/avatars/user12.jpg', 1, '在巴厘岛徒步了阿贡火山，虽然很艰辛，但山顶的日出美到窒息。大自然的力量真的很震撼�?, '2026-04-21 13:45:00', 198, 32, 22);
...
(1, 2, NULL, '背包客小�?, '/avatars/user2.jpg', '樱花季真的太美了！请问是几月份去的？', 8),
(1, 1, 1, '旅行达人小明', '/avatars/user1.jpg', '我是3月底4月初去的，正好赶上樱花盛开', 5),
(2, 12, NULL, '自然探索�?, '/avatars/user12.jpg', '长城真的很壮观，下次一定要去！', 12),
(3, 9, NULL, '吃货旅行�?, '/avatars/user9.jpg', '曼谷的美食真的太诱人了，已经加入旅行清单', 15),
(4, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '这些照片拍得太美了，摄影技术真棒！', 20),
(4, 10, 5, '旅行摄影�?, '/avatars/user10.jpg', '谢谢夸奖！那天的光线特别�?, 8),
(5, 6, NULL, '穷游背包�?, '/avatars/user6.jpg', '一个人的旅行也很精彩，学到了很�?, 10),
(6, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '5000元玩纽约太厉害了，请问是怎么做到的？', 18),
(6, 6, 8, '穷游背包�?, '/avatars/user6.jpg', '主要是住青旅和吃街头美食，交通用地铁通票', 12),
(7, 1, NULL, '旅行达人小明', '/avatars/user1.jpg', '水上别墅太梦幻了，蜜月首选！', 25),
(8, 3, NULL, '探险家阿�?, '/avatars/user3.jpg', '阿贡火山徒步确实很挑战，但值得�?, 15);
